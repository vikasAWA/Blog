...
date: 03/04/2025
description: This blog features "How To Solve It With Code"—a fast.ai and Answer.AI course on Dialog Engineering. It demonstrates how AI tools like solveit enable a human-AI coding partnership that breaks complex tasks into manageable steps for building maintainable code.
...
1. **Fully manual coding** – A legendary approach that demands deep expertise.
2. **Fully AI-generated code** – Used by two types of people: seasoned programmers who can verify, debug, and refine AI-generated code (legendary level) and those who rely entirely on AI without understanding what it generates (not-so-cool for someone who enjoys programming).
...
1. **Understand the Problem** – Clearly define the issue at hand.
2. **Devise a Plan** – Map out your approach.
3. **Execute the Plan** – Put your strategy into action.
4. **Review and Improve** – Reflect, refine, and optimize.
...
1. **Web Scraping** – Before this course, I thought web scraping was complex. A dedicated lesson changed that! I built my first project: 
📖 [Gutenberg Book Scraper](https://gist.github.com/vikasAWA/43bdfb0decf47b6e4d1fb6f310371312)

2. **Multimodal AI** – After learning about embeddings and Google’s Gemini models, I built:
🖼️ [Testing Gemini](https://gist.github.com/vikasAWA/4ede2bb926fced270300ddfef6ff62c3) – A project that generates descriptions based on image prompts.
